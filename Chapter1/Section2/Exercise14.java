...
public class Exercise14
{
	...
	Transaction t = new Transaction(1, 1, 2017, 42);
	...
	Transaction one = new Transaction(1, 1, 2017, 42);
	...
	Transaction one = new Transaction(1, 1, 2017, 42);
	Transaction notOne = new Transaction(4, 5, 2016, 50);
	...
	Transaction one = new Transaction(month, day, year, amount);
	Transaction two = new Transaction(month, day, year, amount);
